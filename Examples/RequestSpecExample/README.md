...
This example connects to [JSONPlaceholder](https://jsonplaceholder.typicode.com) (a free fake REST API) and demonstrates all the common patterns you'll need when building your own API clients.
